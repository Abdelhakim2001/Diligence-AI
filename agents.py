...
def get_client() -> Mistral:
    # Load .env fresh every time so the key is always current,
    # even if this module was imported before main.py called load_dotenv()
    load_dotenv(override=True)
    api_key = os.getenv("MISTRAL_API_KEY", "")
    if not api_key:
        raise ValueError("MISTRAL_API_KEY environment variable not set. Check your .env file.")
